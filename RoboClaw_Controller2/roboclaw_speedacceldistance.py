...
while(1):
	...
	roboclaw.SpeedAccelDistanceM1(address,12000,0,0,0);  #distance traveled is v*v/2a = 12000*12000/2*12000 = 6000
	roboclaw.SpeedAccelDistanceM2(address,12000,0,0,0);  #that makes the total move in ondirection 48000
	buffers = (0,0,0)
	...
	roboclaw.SpeedAccelDistanceM1(address,12000,-12000,42000,1);
	roboclaw.SpeedAccelDistanceM2(address,12000,12000,42000,1);
	roboclaw.SpeedAccelDistanceM1(address,12000,0,0,0);
	roboclaw.SpeedAccelDistanceM2(address,12000,0,0,0);
	buffers = (0,0,0)
	while(buffers[1]!=0x80 and buffers[2]!=0x80):	#Loop until distance command has completed
		displayspeed()
		buffers = roboclaw.ReadBuffers(address)
